 ...
 */
 ...
 @:build(PaletteLoader.LoadPalette("assets/data/palettes/pal.gpl"))
class Palette
{
	
	//private static var angle : Float = 0;
	//
	...
	//}
	//public static function reset(v : Float)
	//{
		//angle = v;
	//}
	//
	...
	//{
		//return FlxColor.fromHSB(angle, 0.1, 0.9);
	//}
	//
	//public static function primary1 () : Int 
	//{
		//return FlxColor.fromHSB(angle, 0.3, 0.7);
	//}
	//
	//public static function primary2 () : Int 
	//{
		//return FlxColor.fromHSB(angle, 0.5, 0.5);
	//}
	//
	//public static function primary3 () : Int 
	//{
		//return FlxColor.fromHSB(angle, 0.7, 0.3);
	//}
	//
	//public static function primary4 () : Int 
	//{
		//return FlxColor.fromHSB(angle, 0.8, 0.2);
	//}
	//
	//public static function primary5 () : Int 
	//{
		//return FlxColor.fromHSB(angle, 0.95, 0.05);
	//}
	//
	//
